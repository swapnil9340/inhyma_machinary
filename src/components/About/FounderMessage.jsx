...
export default function FoundersMessage() {
  return (
    <Box sx={{ backgroundColor: '#eaf4fc', py: 6, px: {xs:2 ,md:4},mt:4, textAlign: 'center' }}>
      <Typography variant="h6" fontWeight="medium" gutterBottom sx={{color : "#243E60" ,fontSize: {xs:"20px"  , md:"22px"}}}>
      ...
      <Typography
        variant="body1"
        color="text.primary"
        sx={{ maxWidth: "90%", mx: 'auto', mb: 2 , fontSize: {xs:"16px"  , md:"20px"} ,textAlign : {xs:"justify"} }}
      >
      ...
      <Typography sx={{color : "#1955A6" , fontSize: {xs:"16px"  , md:"22px"}}}> 
